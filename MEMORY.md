...
- 2026-08-29: lan E asked to integrate [[src-voxyz-archify]]. Pin is `.agents/skills/archify/pin.json`. Do not vendor the renderer. Do not copy Archify prompts into `AGENTS.md`. Do not commit `output/archify` HTML or PNG. Tweet 2400x1260 is not a vault gate. See [[archify]] and C47.
