...
- Hunt-harden loop5 (2026-08-27): PR15 merged `9227b47`, wall `17ca40d` v5-hardened (juice read-only, drop OPTIONS, login WAF, burst>=1; identity/Web3/catalog/search/info-leak closed). Hunted v4. Report at 0/N. Studio next-hunt pill. GET /api/Challenges open. Login remaining auth door. See [[hunt-harden-loop]].
