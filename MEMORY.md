...
- Query reads the short [[index]] door. Paper pages live in [[index-papers]]. Source pages live in [[index-sources]]. Do not load those catalogs on a normal query. See D9 and [[musk-algorithm]].
