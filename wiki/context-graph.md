...
[[two-pass-document-processing]] is the dump version of the same cut: retrieve a subset, then spend vision tokens only there. It does not compile a lasting subgraph. See [[contradictions]] C44.
