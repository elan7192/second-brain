...
| Page | Date | One line |
| --- | --- | --- |
| [[src-andrewng-ai-engineering-skills-map]] | 2026-09-05 | @AndrewYNg AI Engineering Skills Map (入vault; plan→exec→deploy/monitor; scarce=spec/arch/verify; five hire skills; harness wraps model; autonomy dial interactive/delegated/looped; four fail modes; polydao recap secondary) |
