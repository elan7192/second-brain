...
[[src-maverick-ultramode]] ran DeepSeek V4 Flash 0731 as agent and verifier on 15 failure-skewed Terminal-Bench tasks, N=5: 24% to 33% overall, 40% to 75% on 4 recoverable tasks. Author estimates +2 to +5 on a full set where the model is already about 83%. See [[contradictions]] C33.
