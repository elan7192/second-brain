...
4. **Reconcile.** Supersede, coexist, or `flag_conflict`. Do not silently pick a side. Disputed rows live in `wiki/claims.csv` and [[contradictions]].
...
[[memory-ablation]] · [[context-graph]] · [[audited-task-contract]] · [[entropy-gate]] · [[trace]] · [[src-marfinxx-trace]] · [[file-memory]] · [[context-compaction]] · [[memory-system]] · [[epistemic-labels]] · [[claims]]
