...
flowchart TB
  ...
  subgraph hunt-ship[Hunt / ship]
    ...
    ingest-brief-2026-08-24-chatgpt-share
    ...
    merge-conflict-report-2026-08-28-chatgpt-share
    ...
    merge-conflict-report-2026-08-28-musk
  ...
  MEMORY --> secret-gateway
  MEMORY --> src-avichawla-trueforge
  MEMORY --> project-skill-stack
  MEMORY --> src-voxyz-writing-system
  hunt --> hunt-ship-loop
  hunt --> disclosures
  maps --> GrowthOS
  ...
  merge-conflict-report-2026-08-28-chatgpt-share --> llm-wiki
  merge-conflict-report-2026-08-28-chatgpt-share --> entropy-gate
  ...
  merge-conflict-report-2026-08-28-musk --> MEMORY
  merge-conflict-report-2026-08-28-musk --> llm-wiki
  ...
  ingest-brief-2026-08-24-jerry-two-pass --> harness-routing
  ingest-brief-2026-08-24-jerry-two-pass --> tokens-as-capital
  ingest-brief-2026-08-24-jerry-two-pass --> context-graph
  merge-conflict-report-2026-08-29-jerry-two-pass --> harness-routing
  merge-conflict-report-2026-08-29-jerry-two-pass --> tokens-as-capital
  merge-conflict-report-2026-08-29-jerry-two-pass --> llm-wiki
  merge-conflict-report-2026-08-29-jerry-two-pass --> context-graph
  merge-conflict-report-2026-08-29-jerry-two-pass --> hunt
  ...
  context-graph --> src-alexprompter-claude-projects
  context-graph --> project-skill-stack
  ...
  harness-routing --> src-voxyz-writing-system
  harness-routing --> src-can1357-daily-tool-replace-2026-08-27
  harness-routing --> src-4ndrearossetti-openconnector
  harness-routing --> src-avichawla-trueforge
  ...
  memory-engineering --> src-alexprompter-claude-projects
  ...
  tokens-as-capital --> flat-context
  tokens-as-capital --> src-avichawla-trueforge
