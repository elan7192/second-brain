...
6. Optional system map: [[archify]]. Five typed maps live under `output/archify/` (architecture, ingest workflow, query sequence, claims data flow, claim lifecycle). Wiki stays the store.
